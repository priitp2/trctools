...
TRACKED_OPS = {
    ...
    'EXEC':ops.ops_factory('EXEC', CURSOR,
        'c=73,e=73,p=1,cr=2,cu=3,mis=4,r=5,dep=6,og=7,plh=2725028981,tim=5793511830834', FNAME,
        LINE),
    'CLOSE':ops.ops_factory('CLOSE', CURSOR, 'c=0,e=4,dep=0,type=3,tim=5793512315335', FNAME, LINE),
...
UNTRACKED_OPS = {
    ...
    'XCTEND':ops.ops_factory('XCTEND', None, 'rlbk=0, rd_only=1, tim=5793512315347', FNAME, LINE),
